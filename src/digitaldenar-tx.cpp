...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DigitalDenar Core digitaldenar-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  digitaldenar-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded digitaldenar transaction") + "\n" +
                               "  digitaldenar-tx [options] -create [commands]   " + _("Create hex-encoded digitaldenar transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded digitaldenar transaction
