...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DigitalDenar server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DigitalDenar server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DigitalDenar features */
        {"digitaldenar", "masternode", &masternode, true, true, false},
        {"digitaldenar", "listmasternodes", &listmasternodes, true, true, false},
        {"digitaldenar", "getmasternodecount", &getmasternodecount, true, true, false},
        {"digitaldenar", "masternodeconnect", &masternodeconnect, true, true, false},
        {"digitaldenar", "masternodecurrent", &masternodecurrent, true, true, false},
        {"digitaldenar", "masternodedebug", &masternodedebug, true, true, false},
        {"digitaldenar", "startmasternode", &startmasternode, true, true, false},
        {"digitaldenar", "createmasternodekey", &createmasternodekey, true, true, false},
        {"digitaldenar", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"digitaldenar", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"digitaldenar", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"digitaldenar", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"digitaldenar", "getmasternodescores", &getmasternodescores, true, true, false},
        {"digitaldenar", "mnbudget", &mnbudget, true, true, false},
        {"digitaldenar", "preparebudget", &preparebudget, true, true, false},
        {"digitaldenar", "submitbudget", &submitbudget, true, true, false},
        {"digitaldenar", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"digitaldenar", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"digitaldenar", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"digitaldenar", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"digitaldenar", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"digitaldenar", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"digitaldenar", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"digitaldenar", "checkbudgets", &checkbudgets, true, true, false},
        {"digitaldenar", "mnsync", &mnsync, true, true, false},
        {"digitaldenar", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> digitaldenar-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:31325/\n";
}
