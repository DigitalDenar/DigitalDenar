...
int nStakeTargetSpacing = 60; // DigitalDenar: 1 minute blocks during POS (block 201+)
...
{
    // DigitalDenar will hash in the transaction hash and the index number in order to make sure each hash is unique
