...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DigitalDenar Core"),
     ...
     * override -datadir in the digitaldenar.conf file in the default data directory
     * (to be consistent with digitaldenard behavior)
     */
    if (dataDir != getDefaultDataDirectory())
