...
/** Utility functions used by the DigitalDenar Qt UI.
 */
namespace GUIUtil
{
...
// Render DDEN addresses in monospace font
...
// Parse "digitaldenar:" URI into recipient object, return true on successful parsing
