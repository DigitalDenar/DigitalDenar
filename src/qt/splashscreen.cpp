...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("DigitalDenar Core");
    ...
    QString copyrightTextDDEN = QChar(0xA9) + QString("").arg(COPYRIGHT_YEAR) + QString(tr(" 2019 The DigitalDenar Core developers"));
    ...
    pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextDDEN);
