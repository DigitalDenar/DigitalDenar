Contributing to DigitalDenar Core
==================================

The DigitalDenar Core project operates an open contributor model where anyone is
...
The following applies to code changes to the DigitalDenar Core project, and is not to be
confused with overall DigitalDenar Network Protocol consensus changes.

Whether a pull request is merged into DigitalDenar Core rests with the project merge
...
Patches that change DigitalDenar consensus rules are considerably more involved than
...
Where a patch set proposes to change the DigitalDenar consensus, it must have been
...
The project leader is the release manager for each DigitalDenar Core release.
