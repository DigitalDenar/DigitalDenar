...
#   c) node1 mines 32 blocks, so now node 0 has 500000DDEN, node 1 has 4250DDEN, node2 has none.
#   d) node0 sends 601 DDEN to node2, in two transactions (301 DDEN, then 300 DDEN).
