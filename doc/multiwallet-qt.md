...
In order to support loading of multiple wallets in digitaldenar-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is digitaldenar.cpp.
...
Changes to digitaldenar.cpp
----------------------
digitaldenar.cpp is the entry point into digitaldenar-qt, and as such, will require some minor modifications to provide hooks for
