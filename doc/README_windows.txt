...
Intro
-----
DigitalDenar (DDEN) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. DigitalDenar utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run digitaldenar-qt.exe.

DigitalDenar Core is the original DigitalDenar client and it builds the backbone of the network.
However, it downloads and stores the entire history of DigitalDenar transactions;
